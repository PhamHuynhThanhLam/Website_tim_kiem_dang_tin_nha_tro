...
namespace Websitedangtintimkiemnhatro.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.Id).UseIdentityColumn();
                entity.HasOne(a => a.Account).WithOne(u => u.Role).HasForeignKey<Account>(u => u.RoleId).OnDelete(DeleteBehavior.Cascade);
            });
            ...
            modelBuilder.Entity<Detail>(entity =>
            {
                entity.Property(e => e.Id).UseIdentityColumn();
                entity.Property(e => e.Id).UseIdentityColumn();
                entity.HasOne(a => a.Motel).WithOne(u => u.Detail).HasForeignKey<Motel>(u => u.DetailId).OnDelete(DeleteBehavior.Cascade);
